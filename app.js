import Map from 'https://cdn.jsdelivr.net/npm/ol@6.15.1/Map.js';
import View from 'https://cdn.jsdelivr.net/npm/ol@6.15.1/View.js';
import Overlay from 'https://cdn.jsdelivr.net/npm/ol@6.15.1/Overlay.js';
import TileLayer from 'https://cdn.jsdelivr.net/npm/ol@6.15.1/layer/Tile.js';
import VectorLayer from 'https://cdn.jsdelivr.net/npm/ol@6.15.1/layer/Vector.js';
import OSM from 'https://cdn.jsdelivr.net/npm/ol@6.15.1/source/OSM.js';
import VectorSource from 'https://cdn.jsdelivr.net/npm/ol@6.15.1/source/Vector.js';
...
const pointsSource = new VectorSource({ features: [] });
...
const map = new Map({
	...
	view: new View({
		center: fromLonLat(peruCenterLonLat),
		zoom: 5
	}),
	...
	for (const r of results) {
		...
		item.addEventListener('click', () => {
			...
			if (r.boundingbox && r.boundingbox.length === 4) {
				...
				const extent = transformExtent([lonMin, latMin, lonMax, latMax], 'EPSG:4326', map.getView().getProjection());
